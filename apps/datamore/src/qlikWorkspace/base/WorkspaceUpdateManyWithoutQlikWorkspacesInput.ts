...
@InputType()
class WorkspaceUpdateManyWithoutQlikWorkspacesInput {
...
export { WorkspaceUpdateManyWithoutQlikWorkspacesInput as WorkspaceUpdateManyWithoutQlikWorkspacesInput };
