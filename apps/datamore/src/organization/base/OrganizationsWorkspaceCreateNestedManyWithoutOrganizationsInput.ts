...
@InputType()
class OrganizationsWorkspaceCreateNestedManyWithoutOrganizationsInput {
...
export { OrganizationsWorkspaceCreateNestedManyWithoutOrganizationsInput as OrganizationsWorkspaceCreateNestedManyWithoutOrganizationsInput };
