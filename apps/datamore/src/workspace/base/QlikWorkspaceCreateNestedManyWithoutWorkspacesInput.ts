...
@InputType()
class QlikWorkspaceCreateNestedManyWithoutWorkspacesInput {
...
export { QlikWorkspaceCreateNestedManyWithoutWorkspacesInput as QlikWorkspaceCreateNestedManyWithoutWorkspacesInput };
