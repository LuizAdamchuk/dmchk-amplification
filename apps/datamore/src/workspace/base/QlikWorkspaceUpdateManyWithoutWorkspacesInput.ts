...
@InputType()
class QlikWorkspaceUpdateManyWithoutWorkspacesInput {
...
export { QlikWorkspaceUpdateManyWithoutWorkspacesInput as QlikWorkspaceUpdateManyWithoutWorkspacesInput };
