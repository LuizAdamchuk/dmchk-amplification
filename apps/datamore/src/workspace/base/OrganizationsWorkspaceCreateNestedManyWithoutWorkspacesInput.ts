...
@InputType()
class OrganizationsWorkspaceCreateNestedManyWithoutWorkspacesInput {
...
export { OrganizationsWorkspaceCreateNestedManyWithoutWorkspacesInput as OrganizationsWorkspaceCreateNestedManyWithoutWorkspacesInput };
